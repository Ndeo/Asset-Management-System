  ...
  <head>
      <script type="text/javascript"> 
        ...
        function hideToDate() { 
            ...
            // {
                // document.getElementById("example-select1").disabled = true; 
    ...
    //   select.innerHTML= "<option>"+dt+"</option>";
    ...
    // select.getElementsByTagName('option')[1].selected = 'selected'
        ...
        select.getElementsByTagName('option')[dt-1969].selected = 'selected';
            ...
            //     document.getElementById("example-select1").disabled = flase; 
        ...
        //  if( document.getElementById("To-Date-Hide-Spec").style.display == "none"){
        //      document.getElementById("To-Date-Hide-Spec").style.display = "block";
            
        
        // }else
        // {
        //     document.getElementById("To-Date-Hide-Spec").style.display = "none";
        <?php
                  ...
                  <div class="tab-pane show active" id="Assets">
                    <h4 class="header-title mb-3">Time Period</h4>
                        <div class="form-group mb-3">
                            <form method="post" action="report_layout.php">
