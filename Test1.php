...
class Asset
{
     ...
     * @param $exit_date
     */
    public function __construct($id, $name, $group, $description, $entered_value, $deperciation_rate, $entry_date, $availability, $entered_by, $updated_on, $is_periodic, $asset_type, $frequency, $exit_date)
    {
        $this->initialize();
